...
function NavBarProfile({ handleVisibleReset }) {
  ...
  return (
    <>
      ...
      <img className="navbar-profile__toggle-button" src={toggleButtonBlack} onClick={handleToggleMenuHomeAppear}/>
          ...
          {isMenuHomeToggled && (
            <section className="menu">
              ...
              <div className="menu-profile__bottom">
                <h2 className="menu-profile__home">Home</h2>
                <button className="menu-profile__signin" onClick={handleLogOut} >Sign in</button>
              </div>
            </section>
          )}
    </>
